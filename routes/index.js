...
router.post('/api/v1/business/savebusiness', business.savebusiness);
router.get('/api/v1/business/details', business.getBusiness);

//Business Services
router.post('/api/v1/service/addservice', service.saveservice);
router.get('/api/v1/service/list', service.getAllServices);
